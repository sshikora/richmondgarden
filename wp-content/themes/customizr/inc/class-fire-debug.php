...
class TC_debug {
    ...
    */
        ...
        <div id="debug">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="notes">
                ...
                <p style="color:white">For simplification purposes, the theme uses few WP templates : header.php, index.php, footer.php, comments.php. <br/>
    ...
    function tc_get_func_hook($function) {
      ...
      $type   = isset ($this -> hooks[$hook]['type']) ? $this -> hooks[$hook]['type'] : null;

      return array('hook' => $hook, 'type' => $type);
    }
    ...
    */
    ...
    function tc_create_hook_tree() {
      ...
      //create a clean and complete array of hooks
      foreach ($instance_groups as $group) {
        foreach ($this -> hooks as $hook => $data) {
          if ($group == $data['group']) {
            unset($data['group']);
